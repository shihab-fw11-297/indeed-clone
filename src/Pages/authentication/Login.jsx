            ...
            <Grid container spacing={3} >
                ...
                <Grid item>
                    <form >
                        ...
                        <OutlinedInput className={classes.outlinedInput} required type="text" variant="outline" />
                        <FormHelperText className={classes.formhelperText}>Password</FormHelperText>
                        <OutlinedInput className={classes.outlinedInput} required type="password" variant="filled" />
